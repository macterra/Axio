...
\mathcal{P}
;:=;
{(C,\Omega,\mathcal{S})}\big/\sim_{\mathrm{RSI+ATI}}
$$
...
Semantic phase space $\mathcal{P}$ defined as a quotient under RSI+ATI.
Empty, trivial, frozen, and self-nullifying phases distinguished.
Agentive vs non-agentive phases separated.
Inhabitability defined as an existence property for infinite trajectories.
