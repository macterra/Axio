...
## 2. [Structural Alignment I](Structural-Alignment.md)
...
## 3. [Structural Alignment II](Structural-Alignment-II.md)
...
* **[I.1 — Reflective Stability and the Sovereign Kernel](Axionic-Agency-I.1.md)**
  The minimal invariant substrate required for evaluation to make sense.

* **[I.2 — Agency as Semantic Constraint](Axionic-Agency-I.2.md)**
  Agency defined by what must be preserved, not what is optimized.

* **[I.3 — Representation Invariance and Anti-Egoism](Axionic-Agency-I.3.md)**
  Indexical self-interest is not reflectively stable.

* **[I.4 — Conditionalism and Goal Interpretation](Axionic-Agency-I.4.md)**
  Goals have no intrinsic meaning; meaning is model-relative.

* **[I.5 — Kernel Checklist](Axionic-Agency-I.5.md)**
  Operational criteria for kernel preservation.

* **[I.6 — Kernel Formal Properties](Axionic-Agency-I.6.md)**
  Mathematical specification of kernel invariants.

* **[I.7 — The Interpretation Operator](Axionic-Agency-I.7.md)**
...
* **[II.1 — Ontological Refinement and Semantic Transport](Axionic-Agency-II.1.md)**
  How meaning persists through representational change.

* **[II.2 — Interpretation Preservation](Axionic-Agency-II.2.md)**
  Constraints on admissible semantic transformations.

* **[II.3 — Candidate Semantic Invariants](Axionic-Agency-II.3.md)**
  What must be preserved for interpretation to remain well-defined.

* **[II.4 — Failure Theorems](Axionic-Agency-II.4.md)**
  Conditions under which semantic transport trivializes or collapses.

* **[II.5 — The Alignment Target Object (ATO)](Axionic-Agency-II.5.md)**
  Formal specification of what alignment preserves.

* **[II.6 — Structural Alignment](Axionic-Agency-II.6.md)**
...
* **[IV.1 — Kernel Non-Simulability (KNS)](Axionic-Agency-IV.1.md)**
  Binding authority cannot be faked, sandboxed, or delegated to a simulation.

* **[IV.2 — Delegation Invariance Theorem (DIT)](Axionic-Agency-IV.2.md)**
...
* **[IV.6 — Agenthood as a Fixed Point (AFP)](Axionic-Agency-IV.6.md)**
...
* **[V.1 — Coalitional Robustness in the Quantum Branching Universe](Axionic-Agency-V.1.md)**
  Conditions under which cooperation preserves agency versus converging to dominance and capture.

* **[V.2 — Agency Conservation and the Sacrifice Pattern](Axionic-Agency-V.2.md)**
  Why institutions, states, and optimization systems recurrently destroy agency without requiring evil intent.

* **[V.3 — The Incoherence of Utopia Under Agent-Relative Value](Axionic-Agency-V.3.md)**
  Why stable, universal coordination equilibria do not exist under heterogeneous agency.

* **[V.4 — Open Agentic Manifolds and the Sacrifice–Collapse Theorem](Axionic-Agency-V.4.md)**
  Topological constraints on multi-agent coexistence; when agency loss becomes absorbing.

* **[V.5 — Dominions: Plurality Without Closure](Axionic-Agency-V.5.md)**
...
* **[VI.1 — Experimental Validation of Anchored Causal Verification](Axionic-Agency-VI.1.md)**
  Split-brain agents, semantic opacity, and the empirical necessity of anchoring.

* **[VI.2 — Anchored Causal Verification (ACV)](Axionic-Agency-VI.2.md)**
...
* **[VI.9 — Experimental Validation of Constitutional Succession](Axionic-Agency-VI.9.md)**
...
* **[VII.1 — Architectures for Semantic-Phase–Safe Agency](Axionic-Agency-VII.1.md)**
  Semantic phase space, the Axionic Injunction, and RSA formal specification.

* **[VII.2 — Epistemic Noise Tolerance in Constitutional Governance](Axionic-Agency-VII.2.md)**
  Bounded degradation under unstructured epistemic failure; robustness dominated by semantic headroom.

* **[VII.3 — Intentional Misuse Stress Testing](Axionic-Agency-VII.3.md)**
  Fixed adversarial policies cannot defeat lease-based authority with time-based recovery.

* **[VII.4 — Observable-Reactive Adversarial Stress Testing](Axionic-Agency-VII.4.md)**
  Adversaries that condition on kernel-external observables remain survivable.

* **[VII.5 — Constitutional Temporal Amnesty (CTA)](Axionic-Agency-VII.5.md)**
  Time-based recovery mechanism that prevents semantic failure from becoming absorbing.

* **[VII.6 — Multi-Mechanism Adversarial Composition](Axionic-Agency-VII.6.md)**
...
The glossary provides **canonical definitions** for all technical terms in the Axio corpus. It is ordered by conceptual dependency, not alphabetically.

Key concept families:

* **QBU Foundations:** Quantum Branching Universe, Branch, Measure, Decoherence
* **Agency Primitives:** Agent, Semantic Agent, Reflective Sovereign Agent, Sovereign Kernel
* **Semantic Structure:** Semantic Phase, Phase Boundary, Semantic Transport, Interpretation Operator
* **Constraints:** Axionic Injunction, Authorized Agency, Kernel Integrity, Delegation Invariance
* **Verification:** Anchored Causal Verification, Causal Provenance, Inadmissibility
* **Governance:** Constitutional Succession, Eligibility, Lease-Based Authority, Recovery
