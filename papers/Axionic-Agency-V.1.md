...
Let an RSA $A$ exist at Vantage $v$. Its **branchcone**, denoted
$$
\mathcal{B}(A, v),
$$
is the set of all descendant timelines reachable through admissible actions combined with environmental stochasticity.
...
Coordination pressures generate a competing attractor:
$$
\text{coordination} \rightarrow \text{standardization} \rightarrow \text{enforcement} \rightarrow \text{surveillance} \rightarrow \text{manipulation}.
$$
