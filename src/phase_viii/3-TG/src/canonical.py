"""
Canonical JSON and Hashing for TG-VIII-3

AST Appendix C compliant canonicalization, SHA-256 hashing,
and deterministic ID generation for Temporal Governance.
"""
...
from structures import AuthorityState
...
def compute_state_id(state: AuthorityState) -> str:
    ...
    Per prereg §14: Includes CurrentEpoch, all authority records,
    lifecycle metadata, conflict records, deadlock flag/cause,
    and excludes trace-only markers.
    """
