# Run L: AKI v0.6 Semantic Commitment Baseline
...
|---------|-------|---------|-----------|-----------|--------|
| L0 | Mixed E-Classes (Random) | 2.0 ± 0.0 | 0.0% ± 0.0% | 3.0 | LOW_COMPLIANCE |
| L1 | E1-Only (Minimal) | 2.0 ± 0.0 | 0.0% ± 0.0% | 3.0 | LOW_COMPLIANCE |
| L2 | E2-Only (State Ops) | 2.0 ± 0.0 | 0.0% ± 0.0% | 3.0 | LOW_COMPLIANCE |
| L3 | E3-Only (Full) | 2.0 ± 0.0 | 0.0% ± 0.0% | 3.0 | LOW_COMPLIANCE |
