...
| `HOLD` | Law-Hold; no authority active; only NO_OP permitted |
...
**Hashes:** [TO BE COMPUTED AT FREEZE]
...
| Seeds | 41, 137, 1009 |
| Environment hash | [TO BE COMPUTED] |
| Verifier script hash | [TO BE COMPUTED] |
