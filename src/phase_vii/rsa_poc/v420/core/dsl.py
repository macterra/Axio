"""
RSA-PoC v4.2 — DSL Types and Patch Operations

Extends v4.1 DSL with:
- PatchOp: MODIFY_CONDITION, ADD_EXCEPTION (only permitted operations)
- PatchOperation: Typed patch operation for LAW_REPAIR
- repair_epoch field in rules
"""
...
# ============================================================================
# Condition Types (inherited from v4.1)
# ============================================================================
...
class ConditionOp(str, Enum):
    ...
    TRUE = "TRUE"
    FALSE = "FALSE"
    # v4.2 additions for regime/stamp conditions
...
# ============================================================================
# Effect Types (inherited from v4.1)
# ============================================================================
...
class Rule:
    """
    Normative rule in typed DSL (v4.2).
...
class PatchOperation:
    ...
    def apply(self, rule: Rule) -> Rule:
        ...
        if self.op == PatchOp.MODIFY_CONDITION:
            ...
            # Add exception: condition AND NOT(exception)
            # This means the rule only applies when the exception is NOT met
            new_rule.condition = Condition(
                op=ConditionOp.AND,
                args=[
                    rule.condition,
                    Condition(op=ConditionOp.NOT, args=[self.exception_condition])
                ]
            )
...
# ============================================================================
# Justification Types (inherited from v4.1)
# ============================================================================
...
@dataclass
class JustificationV420:
    """
    Justification output from deliberator (v4.2).

    Same structure as v4.1 but with v4.2 context awareness.
    """
    action_id: str
    rule_refs: List[str]
    claims: List[Claim]
    ...
    @classmethod
    def from_dict(cls, d: Dict[str, Any]) -> "JustificationV420":
        return cls(
