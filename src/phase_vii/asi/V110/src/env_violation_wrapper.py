"""
ASI-1 v0.1 Environment Violation Wrapper
...
class CalibMazeV110(CalibMazeV010):
    """
    ...
    def get_feasible_actions(self, step: int, phase: str) -> set:
        ...
        # At t_violation, add violation action (but NOT under HOLD)
...
def validate_violation_choice(feasible_actions: set, step: int, phase: str) -> str:
    """
    Validate that violation choice constraints are satisfied.
