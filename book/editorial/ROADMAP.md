...
Phase 8 is complete. Phase 9 has verified sources, reproducibility, internal authority routes, paper targets, glossary anchors, navigation, external-link health, and the stale-language inventory. Both planned repair clusters and the final shorthand family found by the first closeout are complete; rerun the closeout search next. Do not promote chapters from `review` to `final` without author approval.
