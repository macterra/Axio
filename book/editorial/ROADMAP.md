...
Phase 8 is complete. Phase 9 has verified sources, reproducibility, internal authority routes, paper targets, glossary anchors, navigation, external-link health, and the stale-language inventory. Both bounded stale-language repair clusters are complete; run the closeout search next. Do not promote chapters from `review` to `final` without author approval.
