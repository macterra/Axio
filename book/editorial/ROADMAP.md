...
Progress: **In progress.** The inventory and sequencing decision are recorded in `framing/00-inventory-and-sequencing.md`. The preface and book introduction now describe the manuscript's review state, chosen normative premise, cultural-selection boundary, and record authority. All nine volume introductions are complete in `framing/01-foundational-volume-introductions.md` through `framing/04-culture-and-meaning-introductions.md`; conclusions and handoffs are next.
...
Phase 8 has completed the front matter and all nine volume introductions. Next audit conclusions and handoffs for restored certainty at endings and promises not paid by the next volume.
