...
Phase 8 is complete. Phase 9 has verified sources, reproducibility, internal authority routes, paper targets, glossary anchors, navigation, external-link health, and the stale-language inventory. The residual pattern/reification repair is complete; mutable legal time pegs and AI-state scope are next. Do not promote chapters from `review` to `final` without author approval.
