...
Phase 8 is complete. Phase 9 has verified sources, reproducibility, internal authority routes, paper targets, glossary anchors, navigation, external-link health, and the stale-language inventory. Next repair the bounded residual pattern/reification family, then mutable time pegs and AI-state scope. Do not promote chapters from `review` to `final` without author approval.
