...
| Continuous reading | **In progress; Volumes 1–2 complete** | `09-volume-1-continuity-and-copyedit.md` and `10-volume-2-continuity-and-copyedit.md` record the first two continuous passes and their bounded repairs. Continue Volumes 3–5, then 6–9. |
...
5. **In progress — Continuous reading and copyedit signoff.** `09-volume-1-continuity-and-copyedit.md` and `10-volume-2-continuity-and-copyedit.md` record Volumes 1–2. Continue by volume across the load-bearing Volumes 3–5 sequence, then Volumes 6–9.
