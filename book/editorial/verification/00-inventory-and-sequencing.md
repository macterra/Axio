...
| Continuous reading | **Complete; Volumes 1–9** | `09-volume-1-continuity-and-copyedit.md` through `17-volume-9-continuity-and-copyedit.md` record all nine continuous passes and their bounded repairs. |
...
5. **Complete — Continuous reading and copyedit signoff.** `09-volume-1-continuity-and-copyedit.md` through `17-volume-9-continuity-and-copyedit.md` record Volumes 1–9.
