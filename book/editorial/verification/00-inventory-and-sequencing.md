...
4. **Repairs in progress — Obsolete terms, superseded claims, dated pegs, and blog furniture.** `04-stale-language-inventory.md` records the clean drafting-marker/blog-furniture searches and classifies time-language and metaphor families. `05-residual-pattern-reification.md` completes the first selected repair cluster; mutable legal/AI time language remains.
