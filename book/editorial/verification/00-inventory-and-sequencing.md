...
| Continuous reading | **In progress; Volumes 1–4 complete** | `09-volume-1-continuity-and-copyedit.md` through `12-volume-4-continuity-and-copyedit.md` record the first four continuous passes and their bounded repairs. Continue Volume 5, then Volumes 6–9. |
...
5. **In progress — Continuous reading and copyedit signoff.** `09-volume-1-continuity-and-copyedit.md` through `12-volume-4-continuity-and-copyedit.md` record Volumes 1–4. Continue with Volume 5 to close the load-bearing sequence, then Volumes 6–9.
