...
| Continuous reading | **In progress; Volumes 1–6 complete** | `09-volume-1-continuity-and-copyedit.md` through `14-volume-6-continuity-and-copyedit.md` record the first six continuous passes and their bounded repairs. Continue Volumes 7–9. |
...
5. **In progress — Continuous reading and copyedit signoff.** `09-volume-1-continuity-and-copyedit.md` through `14-volume-6-continuity-and-copyedit.md` record Volumes 1–6. Continue with Volumes 7–9.
