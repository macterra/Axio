...
| Continuous reading | **In progress; Volume 1 complete** | `09-volume-1-continuity-and-copyedit.md` records the first continuous pass and its bounded repairs. Continue Volumes 2–5, then 6–9. |
...
5. **In progress — Continuous reading and copyedit signoff.** `09-volume-1-continuity-and-copyedit.md` records Volume 1. Continue by volume across the load-bearing Volumes 2–5 sequence, then Volumes 6–9.
