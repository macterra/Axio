...
| Obsolete terminology and superseded claims | **Bounded repair complete** | `04-stale-language-inventory.md` confirms the Phase 7 firewalls; `05-residual-pattern-reification.md` records the three selected pattern/attractor repairs. |
...
| Dated news pegs | **Bounded repair complete** | `06-mutable-time-and-ai-scope.md` dates the two legal snapshots and scopes unversioned AI-state claims to their evidence; dated records and rhetorical indexicals remain intentionally. |
...
4. **Closeout pending — Obsolete terms, superseded claims, dated pegs, and blog furniture.** `04-stale-language-inventory.md` records the clean drafting-marker/blog-furniture searches and classifies time-language and metaphor families. `05-residual-pattern-reification.md` and `06-mutable-time-and-ai-scope.md` complete both selected repair clusters; the first closeout found one final agentive/deterministic family, repaired in `07-final-agentive-shorthand.md`. Re-run the ledgers and record final dispositions.
