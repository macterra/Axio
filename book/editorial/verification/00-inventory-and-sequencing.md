...
| Continuous reading | **In progress; Volumes 1–3 complete** | `09-volume-1-continuity-and-copyedit.md` through `11-volume-3-continuity-and-copyedit.md` record the first three continuous passes and their bounded repairs. Continue Volumes 4–5, then 6–9. |
...
5. **In progress — Continuous reading and copyedit signoff.** `09-volume-1-continuity-and-copyedit.md` through `11-volume-3-continuity-and-copyedit.md` record Volumes 1–3. Continue by volume across the load-bearing Volumes 4–5 sequence, then Volumes 6–9.
