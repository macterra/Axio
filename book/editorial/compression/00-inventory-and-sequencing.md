...
5. **In progress — Cross-volume and line pass.** The first bounded family, coercion, retained nine complete formulations that introduce a taxonomy or compare adjacent categories and replaced five later recitals with inherited links; the result is recorded in `11-cross-volume-coercion-definition.md`. The second audit examined cross-volume recaps of “all truth is conditional” and found that the later uses are compact orientation bridges or domain-specific applications rather than repeated defenses; `12-cross-volume-conditionalism-recaps.md` records the no-cut decision. The third audit, recorded in `13-cross-volume-purpose-relative-models.md`, retained distinct model layers while compressing two inherited primers in Volume 3 Chapters 3 and 19 by 156 body words. The fourth audit, recorded in `14-cross-volume-faith-update-rule.md`, corrected one inconsistent use of *faith* and compressed two inherited Volume 2 defenses by 197 body words while preserving the broader religious and constructive uses in Volume 9. The fifth audit, recorded in `15-cross-volume-no-value-without-valuer.md`, compressed Volume 5 Chapter 4's repeated public-goods prosecution and restored the valuer to Volume 9 Chapter 14's process language, a net reduction of 303 body words. The sixth audit, recorded in `16-cross-volume-sacrifice-opportunity-cost.md`, replaced Volume 6 Chapter 17's “true valuation” claims with condition-bound reservation-price and coverage evidence and added Volume 9's missing canonical bridge, a net reduction of 57 body words. The seventh audit, recorded in `17-cross-volume-viability-persistence.md`, retained the physical, reflective, institutional, and meaning applications while correcting Volume 8 Chapter 4's inference from durable transmission to usefulness, voluntary endorsement, and agency support. The eighth audit, recorded in `18-cross-volume-qbu-primer.md`, retained the independent-volume bridges, corrected one canonical-ownership link, and limited “everything happens” to represented nonzero-amplitude outcomes under the specified model. The ninth audit, recorded in `19-cross-volume-agency-layers.md`, retained the qualified machine, standing, political, institutional, cultural, and meaning bridges while correcting Volume 3 Chapter 8's treatment of agency as a pragmatic construct. The next inventory target is coherence-layer recaps.

**Current continuation:** The twenty-first audit, recorded in `31-cross-volume-civilizational-progress.md`, restores the boundary between descriptive selection and political evaluation. Volume 7 now names agency preservation and reduced coercion as the book's chosen standard for judging institutional history rather than civilization's evolved direction, while Volume 6 retains outcome-indexed empirical progress and Volume 8 retains the no-global-direction boundary for cultural selection. The next bounded family awaits inventory.
