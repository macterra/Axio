...
**Current continuation:** The sixteenth audit, recorded in `26-cross-volume-harm-coercion-consent-force-violence.md`, restores the operational boundaries among impact, wrongfulness, authorization, threat, direct compulsion, and physical injury across five later recaps. The next bounded family awaits inventory.
