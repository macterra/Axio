...
**Current continuation:** The twenty-fourth audit, recorded in `34-cross-volume-moral-pressure-extortion-comparisons.md`, preserves the manuscript's bounded slavery, mugging, and funding comparisons while restoring the canonical threat requirement. Volume 5 Chapter 15 now distinguishes moral influence from coercion; Volume 8 Chapter 13 reserves *protection racket* for an actual demand backed by threatened setback. The next bounded family awaits inventory.
