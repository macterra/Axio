...
**Current continuation:** The twenty-second audit, recorded in `32-cross-volume-loaded-dice-choice-structure.md`, retains the distinct probability calculations while correcting one inference from a tilted parenthood distribution to wholly voluntary choice. Volume 6 Chapter 23 now names heterogeneous options, bargaining positions, norms, and institutions; the distribution alone establishes neither discrimination nor free consent. The next bounded family awaits inventory.
