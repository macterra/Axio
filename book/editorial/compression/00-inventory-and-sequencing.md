...
**Current continuation:** The eighteenth audit, recorded in `28-cross-volume-evolution-selection-progress.md`, restores selection's retrospective, mechanism-bound claim ceiling in two later recaps. Increased control remains contingent on reproductive advantage in particular lineages, progress remains an agent's evaluation, and threat-sensitive political deference remains a mixed biological-and-cultural hypothesis rather than a universal group-selection result. The next bounded family awaits inventory.
