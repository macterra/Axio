...
3. **In progress — Volume 7: continuous-reading pass.** The legitimacy-and-rights cluster is recorded in `02-volume-7-legitimacy-and-rights.md`; speech and law are next. Continue by argumentative mechanism without collapsing distinct institutional objections.
