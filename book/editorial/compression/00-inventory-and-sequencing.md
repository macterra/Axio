...
**Current continuation:** The eleventh audit, recorded in `21-cross-volume-consciousness-sentience-sapience.md`, preserves the functional/phenomenal and welfare/sovereignty firewalls while replacing one species-bound standing comparison with the substrate-neutral distinction between sentient welfare and sapient authorship. The next inventory target is objective-morality and conditional-realism recaps.
