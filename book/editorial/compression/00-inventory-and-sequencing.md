...
**Current continuation:** The twenty-fifth audit, recorded in `35-cross-volume-force-coercion-under-fire.md`, retains the full trolley and Burning Hospital stress test while restoring the boundary among authorized restraint, protective force, wrongful force, imposed harm, and coercive threat. Volume 5 Chapter 25's innocent-shield contradiction remains explicit and unresolved. The next bounded family awaits inventory.
