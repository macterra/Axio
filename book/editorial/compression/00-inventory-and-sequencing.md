...
**Current continuation:** The seventeenth audit, recorded in `27-cross-volume-games-metagames-incentives.md`, restores the mechanism and claim ceiling of the metagame lens in one Volume 6 recap: cross-level propagation, institutional preservation, and incentive-driven collapse remain conditional explanations rather than optimization by a hidden system-level chooser. The next bounded family awaits inventory.
