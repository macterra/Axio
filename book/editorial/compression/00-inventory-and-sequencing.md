...
**Current continuation:** The fifteenth audit, recorded in `25-cross-volume-measure-credence.md`, restores event-sector ownership of Measure in one Volume 1 recap while preserving Credence as a separate epistemic quantity. The next inventory target is harm, coercion, consent, force, and violence recaps.
