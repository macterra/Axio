...
- **Phase 7 decision:** Chapters 23–27 now form an authoritarian psychology and cycle → liberal structural handicaps → collective-fictions critique → semantic taxonomy → constructive epistemic-discipline relay. Each chapter inherits rather than restates fallibility, coercion, group non-agency, and the factional cycle. The cluster fell from 12,468 to 4,419 body words after continuous rereading preserved every distinct mechanism, qualification, and heading. The unusually concentrated reduction is descriptive and sets no target for later clusters.
