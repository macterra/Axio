...
THESIS_OVERRIDES = {
    ...
    "02-conditionalism/11-measure-and-credence": "Objective branch Measure and subjective Credence are different probability concepts coupled by rational updating rather than interchangeable meanings.",
    "02-conditionalism/14-probability-without-collapse": "Under explicit rationality and typicality assumptions, agents in a branching universe should align Credence with Born Measure.",
    "03-minds-and-machines/07-consciousness-explained": "Consciousness arises when a modeling system includes a recursively updated schema of itself within its world-model.",
    ...
    "03-minds-and-machines/23-the-agency-criterion": "Current language models can model and reason without owning the optimization loop, maintaining stakes, or authoring choices, and therefore need not be agents.",
    ...
    "05-value-and-ethics/09-what-counts-as-coercion": "Coercion is a credible threat of actual harm used to obtain compliance and must be distinguished from persuasion, offense, and direct violence.",
    "05-value-and-ethics/20-risk-is-harm": "Harm includes attributable, non-consensual worsening of an agent's distribution of viable futures, not only bad outcomes already realized.",
    "05-value-and-ethics/22-the-ethics-of-viability": "Given a commitment to sovereign agency, non-coercive coexistence is a stable strategy in the metagame of continued agency.",
    "05-value-and-ethics/26-sapient-agency-realism": "Facts about what preserves or destroys sapient agency are conditionally objective once sapient agents and their constitutive conditions exist.",
