...
I do not assign a replacement point estimate here. The public record contains substantive evidence for a market-associated zoonotic pathway and substantive circumstantial evidence for a laboratory-associated pathway, while the missing animal-source and laboratory records prevent confident calibration of either. The durable lesson is methodological: define hypotheses, separate evidence from priors, model dependence, test sensitivity, disclose sources, and distinguish an illustrative ledger from a calibrated conclusion. That is the epistemic work required before [decisions under uncertainty](23-deciding-under-uncertainty.md) begin.
