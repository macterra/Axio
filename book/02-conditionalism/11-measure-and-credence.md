...
**Credence** is subjective probability: an agent's rational degree of confidence in a proposition, given the information the agent actually has. In branching terms, a central case is self-locating uncertainty about which record the agent occupies or will observe, while allowing that more than one successor may exist. A Credence is a fact about an agent's epistemic state, and so it legitimately varies from agent to agent. Your Credence that the coin lands heads might be 0.5; mine, having watched the same coin come up heads eleven times running, might reasonably sit elsewhere. The world has not changed between us — our information has. Credence is the raw material of belief: as I argued in [What Beliefs Are](08-what-beliefs-are.md), to believe a proposition just is to assign it Credence high enough to act on.
