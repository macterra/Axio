...
The standing accusation against all of this is that it leaves life cold — that a person stripped of faith is stripped of conviction, meaning, and anything worth calling sacred. But epistemic corrigibility is compatible with deep trust, resolve, ritual, and protected commitment. For this project, [Sacred Coherence](18-sacred-coherence.md) names a chosen discipline of correction rather than a claim that every sacred thing reduces to coherence. I set out my convictions in that spirit in the later [Credo](../09-meaning/10-the-credo.md), and a secular model of reverence in [The Secular Sacred](../09-meaning/02-the-secular-sacred.md); the constructive project belongs there. The critical point belongs here, and it is short.

**Epistemic faith**, as stipulated here, is not strength of belief. It is the death of calibration — the moment a model protects its confidence from the correction that should revise it. Other uses of *faith* remain outside that verdict.
