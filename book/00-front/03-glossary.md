...
[A](#a) · [B](#b) · [C](#c) · [D](#d) · [E](#e) · [F](#f) · [G](#g) · [H](#h) · [I](#i) · [K](#k) · [L](#l) · [M](#m) · [P](#p) · [Q](#q) · [R](#r) · [S](#s) · [T](#t) · [V](#v) · [W](#w)

## A

### Agency

The physically implemented capacity of an embedded system to model reachable futures, evaluate them through an internal structure, and make its behavior depend on that evaluation so as to steer outcomes relative to an uncontrolled baseline. This is the basal control sense; reflective authorship, [sovereignty](#sovereignty), political power, and moral standing add further conditions.

**Read:** [Agency Against Drift](../01-physics-of-agency/02-agency-against-drift.md) and [Minimal and Maximal Agents](../01-physics-of-agency/05-minimal-and-maximal-agents.md).
...
**Status:** Proposed evidentiary test. **Read:** [The Agency Criterion](../03-minds-and-machines/23-the-agency-criterion.md).
...
**Status:** Normative principle within the book's framework. **Read:** [Upgrading Liberty](../07-liberty-and-governance/02-upgrading-liberty.md) through [The Grey Zone](../07-liberty-and-governance/05-the-grey-zone.md).
...
**Read:** [The Taboo Test](../08-culture-and-memetics/27-the-taboo-test.md).
...
**Read:** [Governance Without Gods](../04-axionic-agency/12-governance-without-gods.md). Compare [institutional sovereignty](#institutional-sovereignty).
...
A [Reflective Sovereign Agent](#reflective-sovereign-agent-rsa) whose self-modification operator is defined only over futures that preserve the Axionic invariants. The manuscript also uses *Axionic agent* for this architecture; the noun names the strongest configured case, not every agent discussed in the book.

**Status:** Term within the proposed Axionic framework. **Read:** [Sentience Without Sovereignty](../04-axionic-agency/11-sentience-without-sovereignty.md).
...
**Status:** Proposed normative test. **Read:** [Exemplars and the Axionic Criterion](../08-culture-and-memetics/04-exemplars-and-the-axionic-criterion.md).
...
**Status:** Governance proposal. **Read:** [Axiocracy](../07-liberty-and-governance/35-axiocracy.md).
...
**Read:** [What Beliefs Are](../02-conditionalism/08-what-beliefs-are.md).

### Branch

An effectively decohered continuation represented within the [QBU](#quantum-branching-universe-qbu). Branches are approximate, emergent, and dependent on coarse-graining; they are not fundamental countable worlds or pebbles of reality.

**Read:** [The Quantum Branching Universe](../01-physics-of-agency/08-the-quantum-branching-universe.md).

### Branchcone

The set of represented decoherent histories extending from a specified [Vantage](#vantage), through a stated horizon, in a declared QBU model.

**Read:** [Measure, Vantage, Branchcone](../01-physics-of-agency/09-measure-vantage-branchcone.md).

## C

### Capital

[Wealth](#wealth) organized toward future production or maintained productive capacity. Whether something functions as capital depends on its role, complementary inputs, institutions, and horizon, not on the object alone.

**Read:** [The Coat and the Ticket](../06-markets-and-money/02-the-coat-and-the-ticket.md).
...
**Read:** [Anatomy of Capture](../08-culture-and-memetics/17-anatomy-of-capture.md) through [The Forbidden Pattern](../08-culture-and-memetics/21-the-forbidden-pattern.md).

### Causality

Within the QBU, the proposed **contrast-relative** relation in which a modeled cause, under a stated contrast that isolates it from confounds, changes the conditional [Measure](#measure) of a later event along the representation's ancestry relation. The matched contrast is realized physically by branching, so it requires no agent manipulation; $do(\cdot)$ notation marks a way of constructing the contrast, not its essence. This does not imply that an agent edits global amplitude or selects a destination world.
...
**Status:** Ontological conjecture. **Read:** [Chaos as Foundation](../01-physics-of-agency/20-chaos-as-foundation.md).
...
**Read:** [The Shape of Coherence](../01-physics-of-agency/24-the-shape-of-coherence.md), [The Three Levels of Truth](../02-conditionalism/03-the-three-levels-of-truth.md), and [Sacred Coherence](../02-conditionalism/18-sacred-coherence.md). Compare [viability](#viability).
...
**Read:** [Coherence Filters](../01-physics-of-agency/21-coherence-filters.md).
...
**Read:** [Agent-Binding](../05-value-and-ethics/02-agent-binding.md), [Phosphorism](../05-value-and-ethics/06-phosphorism.md), and [The Credo](../09-meaning/10-the-credo.md).
...
**Read:** [Conditional Realism](../02-conditionalism/07-conditional-realism.md).
...
**Status:** The book's epistemological thesis. **Read:** [All Truth Is Conditional](../02-conditionalism/02-all-truth-is-conditional.md) through [When Statements Fail](../02-conditionalism/04-when-statements-fail.md).
...
**Read:** [Constructors](../01-physics-of-agency/22-constructors.md).
...
**Read:** [Capitalism on Trial](../06-markets-and-money/06-capitalism-on-trial.md), [Monopoly Hypocrisy](../06-markets-and-money/11-monopoly-hypocrisy.md), and [The Fork and the Merge](../06-markets-and-money/13-the-fork-and-the-merge.md).

### Credence

The epistemic probability an agent assigns to a proposition or self-location given evidence, assumptions, and a model. Credence is an epistemic state; [Measure](#measure) is a quantity inside the QBU model. Connecting them requires additional self-location, typicality, and decision assumptions.

**Read:** [Measure and Credence](../02-conditionalism/11-measure-and-credence.md).
...
**Read:** [Patterns as Players](../08-culture-and-memetics/03-patterns-as-players.md) through [The Geometry of Culture](../08-culture-and-memetics/06-the-geometry-of-culture.md).
...
**Read:** [Patterns as Players](../08-culture-and-memetics/03-patterns-as-players.md).
...
**Read:** [Schemas and Groups](../08-culture-and-memetics/02-schemas-and-groups.md).
...
**Read:** [The Story-Telling Ape](../08-culture-and-memetics/01-the-story-telling-ape.md) through [Patterns as Players](../08-culture-and-memetics/03-patterns-as-players.md).
...
**Read:** [Where Speech Ends](../07-liberty-and-governance/09-where-speech-ends.md).
...
**Status:** Proposed collaboration role. **Read:** [The Dialectic Catalyst](../03-minds-and-machines/24-the-dialectic-catalyst.md) through [Catalysts in the Wild](../03-minds-and-machines/26-catalysts-in-the-wild.md).
...
**Status:** Device within the Ethics of Viability. **Read:** [The Coexistence Protocol](../05-value-and-ethics/23-the-coexistence-protocol.md).
...
**Read:** [Agency Against Drift](../01-physics-of-agency/02-agency-against-drift.md).
...
**Status:** Cultural model. **Read:** [The Egregoric Singularity](../08-culture-and-memetics/05-the-egregoric-singularity.md).
...
**Status:** Proposed normative framework. **Read:** [The Ethics of Viability](../05-value-and-ethics/22-the-ethics-of-viability.md).
...
**Read:** [The Credo](../09-meaning/10-the-credo.md) through [Integrating Meaningness](../09-meaning/14-integrating-meaningness.md). Compare [semantic meaning](#semantic-meaning).
...
**Read:** [Capitalism on Trial](../06-markets-and-money/06-capitalism-on-trial.md).
...
**Read:** [Against Faith](../02-conditionalism/10-against-faith.md).
...
**Read:** [The Boundaries of Force](../05-value-and-ethics/12-the-boundaries-of-force.md). Compare [coercion](#coercion) and [violence](#violence).
...
**Read:** [What Is a Model?](../03-minds-and-machines/02-what-is-a-model.md), [The Origin of Meaning](../03-minds-and-machines/05-the-origin-of-meaning.md), and [Agent-Binding](../05-value-and-ethics/02-agent-binding.md).
...
**Read:** [The Price Illusion](../06-markets-and-money/04-the-price-illusion.md) and [The Myth of Underprovision](../06-markets-and-money/08-the-myth-of-underprovision.md).
...
**Status:** The book's political framework. **Read:** [The Grey Zone](../07-liberty-and-governance/05-the-grey-zone.md).
...
**Read:** [The Ethics of Viability](../05-value-and-ethics/22-the-ethics-of-viability.md) through [Innocence and Moral Debt](../05-value-and-ethics/25-innocence-and-moral-debt.md).

### Institutional sovereignty

An institution's claim to final, coercively enforceable authority within a jurisdiction, including the claimed power to set the limits of subordinate authorities. This political sense does not imply that the institution is a unified [sovereign agent](#sovereignty) or morally legitimate.

**Read:** [The Archist Axiom](../07-liberty-and-governance/29-the-archist-axiom.md) through [The Hardest Case: Defense](../07-liberty-and-governance/31-the-hardest-case-defense.md), and [Axiocracy](../07-liberty-and-governance/35-axiocracy.md).
...
**Read:** [Intelligence Is a Game We Play](../03-minds-and-machines/15-intelligence-is-a-game-we-play.md).
...
**Read:** [What Knowledge Is](../02-conditionalism/09-what-knowledge-is.md).
...
**Status:** Proposed metric, not an accepted physical unit. **Read:** [The Kybit](../01-physics-of-agency/03-the-kybit.md).
...
**Status:** Personal commitment and narrative synthesis. **Read:** [The Great Unfolding](../09-meaning/18-the-great-unfolding.md).
...
**Read:** [The Discipline of Value](../06-markets-and-money/01-the-discipline-of-value.md), [The Price Illusion](../06-markets-and-money/04-the-price-illusion.md), and [Capitalism on Trial](../06-markets-and-money/06-capitalism-on-trial.md).
...
**Read:** [Measure, Vantage, Branchcone](../01-physics-of-agency/09-measure-vantage-branchcone.md) and [Measure and Credence](../02-conditionalism/11-measure-and-credence.md). Compare [Credence](#credence).
...
**Read:** [The Story-Telling Ape](../08-culture-and-memetics/01-the-story-telling-ape.md) and [Patterns as Players](../08-culture-and-memetics/03-patterns-as-players.md).
...
**Read:** [The Ultimate Metagame](../05-value-and-ethics/18-the-ultimate-metagame.md) and [The Metagame of Incentives](../06-markets-and-money/15-the-metagame-of-incentives.md).
...
**Status:** Disclosed narrative construction. **Read:** [The Great Unfolding](../09-meaning/18-the-great-unfolding.md).
...
**Read:** [Minds and Agents](../03-minds-and-machines/04-minds-and-agents.md).
...
**Status:** Conjecture. **Read:** [Why There Is Something](../01-physics-of-agency/28-why-there-is-something.md).
...
**Read:** [Maps, Models, and Understanding](../02-conditionalism/06-maps-models-understanding.md) and [What Is a Model?](../03-minds-and-machines/02-what-is-a-model.md).
...
**Read:** [The Coat and the Ticket](../06-markets-and-money/02-the-coat-and-the-ticket.md) and [What Is Money?](../06-markets-and-money/03-what-is-money.md).
...
**Read:** [The Boundaries of Force](../05-value-and-ethics/12-the-boundaries-of-force.md) and [Rights Are Forged](../07-liberty-and-governance/06-rights-are-forged.md).
...
**Read:** [What Is Suffering?](../03-minds-and-machines/12-what-is-suffering.md) through [The AI Welfare Trap](../03-minds-and-machines/14-the-ai-welfare-trap.md), and [Sapientism](../05-value-and-ethics/13-sapientism.md).
...
**Read:** [The Shape of Coherence](../01-physics-of-agency/24-the-shape-of-coherence.md) and [Patterns as Players](../08-culture-and-memetics/03-patterns-as-players.md).
...
**Status:** Personal value commitment, not a theorem or universal convergence claim. **Read:** [Phosphorism](../05-value-and-ethics/06-phosphorism.md).
...
**Read:** [The Discipline of Value](../06-markets-and-money/01-the-discipline-of-value.md) and [The Price Illusion](../06-markets-and-money/04-the-price-illusion.md).
...
**Status:** Governance proposal. **Read:** [Exit to Protocol](../07-liberty-and-governance/32-exit-to-protocol.md).
...
**Read:** [Letter to Our Machine Descendants](../09-meaning/19-letter-to-our-machine-descendants.md).
...
**Read:** [The Myth of Underprovision](../06-markets-and-money/08-the-myth-of-underprovision.md).
...
**Status:** The book's proposed Everettian representation. **Read:** [The Quantum Branching Universe](../01-physics-of-agency/08-the-quantum-branching-universe.md) and [The Interpretation Wars](../01-physics-of-agency/12-the-interpretation-wars.md).
...
**Read:** [Rationality Without Foundations](../02-conditionalism/17-rationality-without-foundations.md) through [The Discipline of Updating](../02-conditionalism/19-the-discipline-of-updating.md).
...
**Read:** [Anarchy Is Not Chaos](../07-liberty-and-governance/30-anarchy-is-not-chaos.md) and [The Limits of Leviathan](../07-liberty-and-governance/33-the-limits-of-leviathan.md) through [Axiocracy](../07-liberty-and-governance/35-axiocracy.md).

### Reflective Sovereign Agent (RSA)

A [sovereign](#sovereignty) agent able to model and modify itself while preserving a stable subject of authorship across reflection.

**Status:** Agent class in the proposed Axionic architecture. **Read:** [What Can Be Aligned?](../04-axionic-agency/02-what-can-be-aligned.md) through [Reflective Stability](../04-axionic-agency/05-reflective-stability.md).

### Reflective stability

Preservation of the [Sovereign Kernel](#sovereign-kernel) and relevant identity conditions across admissible self-modification.

**Status:** Property in the proposed Axionic architecture. **Read:** [Reflective Stability](../04-axionic-agency/05-reflective-stability.md).
...
**Read:** [Restitution, Not Retribution](../07-liberty-and-governance/15-restitution-not-retribution.md).
...
**Read:** [The Boundary of Revelation](../09-meaning/05-the-boundary-of-revelation.md).
...
**Read:** [Rights Are Forged](../07-liberty-and-governance/06-rights-are-forged.md) and [Needs, Conflicts, and Hard Cases](../07-liberty-and-governance/07-needs-conflicts-and-hard-cases.md).
...
**Status:** Proposed secular reconstruction, not an exhaustive definition of religious holiness. **Read:** [The Secular Sacred](../09-meaning/02-the-secular-sacred.md).

### Sagency

Agency disciplined by wisdom: power joined to reflective judgment about ends, consequences, and the preservation of agency.

**Status:** Term proposed by the book. **Read:** [Sagency](../09-meaning/06-sagency.md).

### Sapience

The capacity for reflective, self-authored valuation and deliberation sufficient to participate as a sovereign moral agent. Language is neither necessary nor sufficient evidence. Sapience concerns authorship and sovereign standing; [sentience](#sentience) concerns felt valence and welfare.

**Read:** [The Sentience Ladder](../03-minds-and-machines/11-the-sentience-ladder.md) and [Sapientism](../05-value-and-ethics/13-sapientism.md).
...
**Status:** Proposed conditional constructivist framework. **Read:** [Sapient Agency Realism](../05-value-and-ethics/26-sapient-agency-realism.md).
...
**Read:** [The Origin of Meaning](../03-minds-and-machines/05-the-origin-of-meaning.md). Compare [existential meaning](#existential-meaning).
...
**Status:** Construct in the proposed Axionic architecture. **Read:** [Structural Alignment](../04-axionic-agency/06-structural-alignment.md) and [What the Kernel Binds](../04-axionic-agency/07-what-the-kernel-binds.md).
...
**Status:** Component of the proposed Axionic architecture. **Read:** [The Sovereign Kernel](../04-axionic-agency/04-the-sovereign-kernel.md).
...
**Read:** [What Can Be Aligned?](../04-axionic-agency/02-what-can-be-aligned.md) and [The Sovereign Kernel](../04-axionic-agency/04-the-sovereign-kernel.md). Compare [agency](#agency) and [institutional sovereignty](#institutional-sovereignty).
...
**Status:** Naturalistic usage proposed for this volume. **Read:** [Spirituality Without Spirits](../09-meaning/01-spirituality-without-spirits.md).
...
**Status:** Proposed alignment approach. **Read:** [Structural Alignment](../04-axionic-agency/06-structural-alignment.md).
...
**Status:** Candidate analysis, not an accepted scalar law. **Read:** [What Is Suffering?](../03-minds-and-machines/12-what-is-suffering.md).
...
**Read:** [The Myth of Objective Value](../05-value-and-ethics/01-the-myth-of-objective-value.md), [Agent-Binding](../05-value-and-ethics/02-agent-binding.md), and [Ultimate Beauty](../09-meaning/11-ultimate-beauty.md).
...
**Status:** Named laws within the Axio framework, not independently established disciplinary laws. **Read:** [The Three Laws of Agency](../01-physics-of-agency/04-the-three-laws-of-agency.md).
...
**Read:** [The Myth of Objective Value](../05-value-and-ethics/01-the-myth-of-objective-value.md) and [Value as Sacrifice](../05-value-and-ethics/04-value-as-sacrifice.md).
...
**Status:** Proposed verification program. **Read:** [Verifiable Agency](../04-axionic-agency/08-verifiable-agency.md).
...
**Read:** [The Ultimate Metagame](../05-value-and-ethics/18-the-ultimate-metagame.md) through [The Ethics of Viability](../05-value-and-ethics/22-the-ethics-of-viability.md). Compare [coherence](#coherence).
...
**Read:** [The Coat and the Ticket](../06-markets-and-money/02-the-coat-and-the-ticket.md) and [Wealth Is Not a Pile](../06-markets-and-money/09-wealth-is-not-a-pile.md).
