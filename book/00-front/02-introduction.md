...
1. **The Physics of Agency and the Branching Universe** develops a conditional physical account of choice: the thermodynamics of agency, an Everettian quantum branching model, and the distinction between the objective Born weight of a specified event sector ([Measure](03-glossary.md#measure)) and an agent's subjective confidence ([Credence](03-glossary.md#credence)). If choice is physically consequential, the universe and the causal model have to meet stated conditions; this volume proposes what they are, then marks its later metaphysics as a more speculative register.
...
4. **Axionic Agency: The Alignment Program** is the formal core: the conditions under which a system can preserve authorship, valuation, and [sovereignty](03-glossary.md#sovereignty) across self-modification — and the ways that agency collapses under reflection when they fail.

5. **Value and Agency-Centered Ethics** works out where value comes from once the cosmos supplies none. There is no value without a valuer; the volume joins structural descriptions of agents to an openly chosen commitment to protecting their authorship, then tests the resulting ethic at its hardest boundary.

6. **Markets, Money, and Prosperity** scales the argument to many agents at once: what prices and exchange can coordinate, which institutions expose or conceal error, where markets and interventions fail, and how empirical claims about prosperity should be tested.

7. **Liberty, Coercion, and Governance** turns to the political conditions of agency — the difference between cooperation and [coercion](03-glossary.md#coercion), the Grey Zone in which force may or may not be justified, and a governance program judged by this book's chosen commitment to protecting agency.

8. **Culture, Memetics, and Ideology** adds the layer between the individual mind and the political order: [cultural patterns](03-glossary.md#pattern) whose transmission can reward accuracy, resonance, coordination, authority, or repetition in different combinations, and the discipline required to study them without turning patterns into hidden agents.

9. **Meaning, Spirituality, and the Secular Sacred** closes the book. Within the naturalistic framework argued by the preceding volumes, what is left to revere? The last volume reconstructs [sacredness](03-glossary.md#sacred) as a protected practical role, [spirituality](03-glossary.md#spirituality) as experience and pursuit without automatic metaphysical authentication, and [existential meaning](03-glossary.md#existential-meaning) as inherited, encountered, revised, or made significance sustained through participation and endorsement. It ends on a letter to the reader.
...
The book is web-native by design. Chapters link freely to one another across volumes, and outward to two other layers of the record: the [original blog posts](/), which preserve the longer historical path and may contain positions the book supersedes, and the [research papers](/papers/), where formal treatments, proofs, protocols, and run details live. A chapter is the considered synthesis and governs when the records differ. The [Glossary](03-glossary.md) gives short definitions and routes back to the chapters that govern each term of art.
