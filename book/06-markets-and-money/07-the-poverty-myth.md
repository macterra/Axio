...
First, it misdiagnoses. The anxieties packed into the phrase conflate inequality with the genuine problems — poverty, coercion, and lost agency. Disparity in wealth does not by itself establish harm. The relevant evidence is a material setback to welfare, functional capacity, or viable options against an appropriate baseline; coercion is the separate mechanism of using a credible conditional threat to obtain compliance. [What Counts as Harm](../05-value-and-ethics/09-what-counts-as-harm.md) and [What Counts as Coercion](../05-value-and-ethics/10-what-counts-as-coercion.md) keep those categories distinct. Measured in poverty reduction and expanded agency rather than disparity alone, the capitalist era is not a decline. It is the single greatest expansion of human agency in history.
