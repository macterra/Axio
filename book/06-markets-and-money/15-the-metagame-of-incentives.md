...
Games often sit inside larger systems of incentives; where an interaction above the game changes the reasons for playing below, call it a metagame. [The Ultimate Metagame](../05-value-and-ethics/18-the-ultimate-metagame.md) develops that lens while denying that every process belongs to one literal ladder or universal objective. The transmission mechanism is a change in effective incentives: what counts as a win, which strategies are viable, which risks are acceptable, and which outcomes an agent optimizes for. The metagame does not rewrite the formal rules beneath it. Chess remains chess, science remains science, the market remains the market — and how they are played can still shift.
