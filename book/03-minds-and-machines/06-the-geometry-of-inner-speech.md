...
That closing generalization matters for what comes later in this volume. A system that perceives itself by projecting onto internal surfaces is exactly the architecture that the [Modeler-Schema account of consciousness](07-consciousness-explained.md) requires — and the narrating voice, the Controller reporting on experiences it renders but does not constitute, is the inner monologue seen from the inside. The projection is the mechanism; the narration is one of its outputs.
