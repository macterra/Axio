...
What precaution *can* be given is discipline. If certainty is unavailable, calibration is not: the Credences that graduated consideration uses can draw on architecture, behavior, physiology, and theory rather than intuition alone. [The Sentience Metric](13-the-sentience-metric.md) organizes three theory-dependent evidentiary windows; it does not directly measure experience.
