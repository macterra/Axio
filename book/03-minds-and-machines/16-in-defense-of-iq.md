...
My answer starts from a commitment developed in the previous chapter: [intelligence is effectiveness within a game](15-intelligence-is-a-game-we-play.md). A game, in this sense, is any strategic interaction defined by goals, constraints, and choices among alternatives. Strategy presupposes that structure, and intelligence names the effectiveness with which an agent navigates it. Outside a game, intelligence collapses into an undifferentiated abstraction — a word waving at everything and measuring nothing.
