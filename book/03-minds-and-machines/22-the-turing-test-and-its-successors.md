...
sources:
  ...
  - 178016431.beyond-the-turing-test
  - 176577621.the-death-of-the-turing-test
  - 166536003.ex-machina
---
...
The cure is the same vocabulary discipline that [the sentience ladder](11-the-sentience-ladder.md) imposed on *aware*, *sentient*, and *sapient*. Three distinct claims hide inside "machines think":
...
2. **Causal coherence** — modeling not just what follows what, but what *depends* on what: the difference between observing and intervening, the capacity for counterfactual reasoning that [Pearl and the Machine](20-pearl-and-the-machine.md) examined.
...
Turing's durable contribution was to make machine cognition empirically approachable. Many modern systems cross short conversational thresholds, so this chapter contributes evidence for functional cognition without owning the volume's final verdict. A system can pass conversational probes while leaving persistence, preferences, consequences, and choice unsettled. The next chapter states the proposed [Agency Criterion](23-the-agency-criterion.md) and asks what evidence could establish ownership of an optimization loop.
