...
- *Unbound:* "Lying is wrong." Not a proposition. A gesture toward one.
...
- **Relativism dissolves the standard.** Everything is "true for" someone, the frameworks are arbitrary, comparison is refused, and evaluation ends before it begins.
- **Agent-binding names the standard.** The agent's explicitly articulated values are stated, on the table, in the open — which is precisely what makes rigorous evaluation possible.
