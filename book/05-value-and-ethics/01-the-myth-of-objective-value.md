...
Nor does the death of unconditional morality mean that moral claims are beyond criticism, that anything goes, or that the slaveholder's values are insulated from yours. Getting from "all value is agent-relative" to a framework in which moral claims are explicit, evaluable, and genuinely arguable requires one further device — binding each claim to its normative standard and domain — and that is the work of [agent-binding](02-agent-binding.md). At the end of the volume, [Sapient Agency Realism](26-sapient-agency-realism.md) gives the result a deliberately limited name: public, criticizable verdicts under an avowed agency-protection premise. The procedure is assessable; the premise has not become agent-independent.
