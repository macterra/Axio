...
Endangered species and wild places are the favorite case, and the rainforest has already shown how it goes. On this volume's account, "intrinsic value" talk about nature reports somebody's valuation while presenting it as independent of every valuer — usually the speaker's concern generalized into the fabric of the universe. The presentation changes nothing about the underlying structure. The forest's defenders value it; its destroyers value something else more. That is a genuine conflict of valuations, and it can be fought and sometimes won. Calling one side objective does not settle it.

Great works of art and cultural treasures get the same treatment. The reverence people feel before the Sistine Chapel is genuine, and I have no interest in debunking it. But the reverence is always located in someone. It is not floating in the paint. A civilization that ceased to care about the ceiling would not be failing to perceive a value that persisted in the plaster; the value would be gone, because the valuers were. The same holds for mathematical truths: their truth is one thing, their value another. That the theorem holds is independent of us; that the theorem *matters* is not.
...
Notice the shape shared by every counterexample. Each nominates some object as a bearer of agent-independent value, while the two questions that yield evidence are: *valuable to whom?* and *what are they willing to give for it?* Those are better questions than "what is it worth?" asked in a vacuum, because they can be investigated. Choices, trade-offs, and sacrifices supply defeasible evidence of an agent's ordering; duress, misinformation, compulsion, poverty, and constrained alternatives can all distort that evidence. The positive account is developed in [value as sacrifice](04-value-as-sacrifice.md). For now the negative thesis suffices: no valuer, no value.
...
But morality is made of value judgments, and this volume takes all value to be agent-relative. Its target follows: morality cannot be unconditional and independent of every agent, because it has no evaluative standpoint from which to matter. No valuer, no value. No value, no moral claim. This rejects one ambitious kind of realism, not every position philosophers call moral realism. Whether a different, condition-bound sense of objectivity survives is the question answered at the end of the volume.

Morality is an evaluative practice: a vocabulary for expressing and testing what agents value, detest, prioritize, require, and forbid. It includes rules, duties, goals, identities, and taboos, and a moral utterance can prescribe, condemn, coordinate, or commit rather than merely report a preference. What every such judgment requires, on this account, is a standpoint from which its object matters. "Stealing is wrong" may invoke property, trust, consent, or security; stating which standard does the work makes the claim more rather than less arguable.
...
Readers of the earlier volumes will recognize the structure. [All truth is conditional](../02-conditionalism/02-all-truth-is-conditional.md): every interpreted claim depends on background conditions, and progress comes from dragging the conditions into the light. Moral claims additionally depend, on this account, on a normative standpoint that ordinary usage often leaves implicit. That standpoint may belong to an individual, community, or public framework; later chapters make its source and claimed jurisdiction explicit.

## Four Proposed Foundations

Much of moral philosophy has tried to supply moral claims with an agent-independent foundation. Four recurring candidates illustrate why this volume remains unconvinced.
...
On this account, these routes either introduce a normative premise that reason and description did not generate, or appeal to an authority whose standing must itself be valued. That may still yield a serious ethical system. It does not yield value independent of every valuer.
...
That clarity is fake. It is the clarity of the absolutist who has hidden his premises even from himself, and it makes moral disputes interminable, because neither side has any vocabulary for the valuations driving the disagreement. Once you see that morality is structured value, the illusion dissolves, and the questions change. You stop asking "what is the right thing to do?" in a vacuum. You start asking: *What do I value, and what follows from that?* And, where others are involved: *What do we value, and how do we coordinate?*
...
Nor does the death of unconditional morality mean that moral claims are beyond criticism, that anything goes, or that the slaveholder's values are insulated from yours. Getting from "all value is agent-relative" to a framework in which moral claims are explicit, evaluable, and genuinely arguable requires one further device — binding each claim to the agent whose value it is, which turns it into an empirical claim open to evidence — and that is the work of [agent-binding](02-agent-binding.md). At the end of the volume, [Sapient Agency Realism](26-sapient-agency-realism.md) gives the result a deliberately limited name: public, criticizable verdicts under an avowed agency-protection premise. The procedure is assessable; the premise has not become agent-independent.
