...
sources:
  ...
  - 166978754.valorism
  - 166976848.valorism-vs-vitalism
  - 168244764.the-silver-pill
  - 166023954.the-highest-good
  - 168174943.comparing-value-systems
---
...
Here is the uncomfortable part. Vitalism and Valorism are both internally coherent and both reflectively stable — each, judged by its own criteria, is superior to the other. The Valorist looks at unexamined persistence and sees a meaningless one; the Vitalist looks at authenticity purchased with extinction and sees self-defeat. There is no context-independent vantage point from which to break the tie, because [truth claims, including claims about which value system is better, hold only relative to interpretive conditions](../02-conditionalism/02-all-truth-is-conditional.md) — and each system supplies its own. What *can* be said conditionally is that Vitalism prioritizes traits likely to support its own continuation under many environments. Valorism can be more precarious because its adherents accept, on principle, potential extinction over compromise. Neither outcome follows by definition without a unit, environment, transmission mechanism, and horizon. (How chosen values should respond to those persistence facts is the question I return to in [the viability criterion](19-the-viability-criterion.md).)
...
- Flourishing and satisfaction over suffering
