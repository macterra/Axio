...
The previous chapter made a qualified version of this move for harm: [material imposed risk can be a prospective setback](20-risk-is-harm.md) when a policy foreseeably and attributably worsens another agent's position relative to an appropriate baseline. This chapter applies the same distribution-sensitive lens to the acting agent. Physical weights describe part of the shift; classifying it as harm and assigning responsibility still require normative premises.
...
Measure responsibility also qualifies simple outcome-based desert. Responsibility concerns the policy an agent enacted, the foreseeable distribution associated with it, and the local obligations present after an outcome is observed. An agent cannot rewrite the total quantum state from outside it. It can deliberate within its causal position and become more definite through action. Freedom, on this reading, is not unlimited possibility but the capacity of deliberation to participate in which continuation the agent instantiates.
