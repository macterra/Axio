...
This is the value-side counterpart of what Volume 2 established about truth: [interpreted claims require conditions](../02-conditionalism/02-all-truth-is-conditional.md). Normative claims additionally require a standard. The standard may be an individual's commitment, a shared practice, or a public framework, but it is not supplied by causal description alone. [Agent-binding](02-agent-binding.md) makes that normative input and the conditions of its application explicit. It does not make the resulting verdict empirical or reduce truth to whatever a vantage prefers.
