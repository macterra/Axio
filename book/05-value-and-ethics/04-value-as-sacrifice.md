...
The standard here is the same one I apply to belief. In [What Beliefs Are](../02-conditionalism/08-what-beliefs-are.md) I argued that a belief is credence robust enough to drive behavior — credence with teeth. Value has the same grammar: a professed "value" that never shapes choice when relevant costs arrive is evidence of decoration rather than enacted priority.
