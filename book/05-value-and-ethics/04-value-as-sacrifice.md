...
sources:
  ...
  - 164878445.willing-and-able
  - 164882854.opportunity-cost
  - 164847204.the-free-rider-fallacy
---
...
The standard here is the same one I apply to belief. In [What Beliefs Are](../02-conditionalism/08-what-beliefs-are.md) I argued that a belief is credence robust enough to drive behavior — credence with teeth. Value has the same grammar: a "value" that never drives a costly choice is not a value at all. It is a decoration.
...
The kernel of the free rider problem is real. When a good is non-excludable — when you cannot stop people from using it — individuals have less reason to pay for it voluntarily. That is a genuine misalignment of incentives. But it does not follow that the good has value in some objective sense, independent of individual preferences. That leap is [the myth of objective value](01-the-myth-of-objective-value.md) dressed up in economic clothing.

Benefit is not sacrifice, and usage is not willingness to pay. But nonpayment is also ambiguous in a non-excludable setting: a person may value the road and strategically wait for others to fund it. The free-rider problem is precisely why willingness to pay observed under one mechanism cannot be treated as a transparent measure of underlying value. A tax payment likewise does not reveal voluntary valuation. Neither fact alone decides how the good should be funded; that requires a separate argument about coordination, rights, and institutional alternatives.
...
None of this denies that coordination problems are hard. They are. But solving them does not require abandoning the subjectivity of value. Assurance contracts, crowdfunded incentive schemes, and decentralized autonomous organizations all channel voluntary contributions toward non-excludable goods. Open source software is a textbook public good, and much of it is built and maintained without a shred of coercion. Even national defense, the strongest card in the statist hand, does not survive scrutiny as an exception — an argument I make in [Can Markets Provide National Defense?](/posts/165271623.can-markets-provide-national-defense.html) Coordination is hard, but hard is not the same as objective.

The free rider fallacy smuggles coercion in through the back door and calls it a technical fix. Once you admit that value is subjective, the real questions come into focus: who cares enough to act, and how do we align incentives so that action becomes possible — a design problem I take up in [The Metagame of Incentives](/posts/180058480.the-metagame-of-incentives.html) — without pretending that everyone values the same things? We must stop mistaking collective convenience for moral necessity. Coordination does not require coercion, and value never exists apart from the agent who values.
