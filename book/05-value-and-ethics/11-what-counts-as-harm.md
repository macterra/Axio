...
The remedy is the same one applied to [coercion](09-what-counts-as-coercion.md): a precise, functional definition, tested against cases. There is also a debt to pay. Coercion was defined through a credible conditional threat of a material *setback* used to obtain compliance—a definition that borrowed this chapter's term on credit. Here is the payment.
