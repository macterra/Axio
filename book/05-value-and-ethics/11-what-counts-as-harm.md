...
*Agent.* Harm can only occur to an agent — a being capable of valuing, choosing, and acting toward goals. No agent, no harm. A rock cannot be harmed, only altered. This is not a technicality; it is the subjectivist foundation of the whole volume showing through. Since [all value is subjective](01-the-myth-of-objective-value.md), damage is only harm relative to some valuer whose pursuits it impairs.

*Valued goals.* The agent must have identifiable goals it actually cares about pursuing or maintaining — the goals revealed in what it will [sacrifice](04-value-as-sacrifice.md), not the goals an observer thinks it ought to have. Harm degrades the capacity to pursue those goals, not merely the chance of success. Your rival's better product may doom your business, but it does not touch your capacity to compete; it just beats you.
