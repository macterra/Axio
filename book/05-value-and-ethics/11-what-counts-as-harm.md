...
The remedy is the same one applied to [coercion](09-what-counts-as-coercion.md): a precise, functional definition, tested against cases. There is also a debt to pay. Coercion was defined through a credible conditional threat of *harm* used to obtain compliance—invoking a term this chapter had not yet defined. Here is the payment.
