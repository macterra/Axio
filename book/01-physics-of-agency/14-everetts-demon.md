...
Quantum mechanics establishes, experimentally and not as a matter of interpretation, that microscopic events are fundamentally probabilistic. Whether a particular ion channel opens, whether a synaptic vesicle releases its neurotransmitters, how a molecular binding resolves — these are not deterministic facts awaiting a sharper microscope. And in the [Quantum Branching Universe (QBU)](08-the-quantum-branching-universe.md), each such event is a fork: decoherence turns the quantum alternatives into physically distinct, irreversibly diverging timelines, every one of them real.
