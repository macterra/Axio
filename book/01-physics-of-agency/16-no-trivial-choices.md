...
The second is quantum branching. In the [Quantum Branching Universe (QBU)](08-the-quantum-branching-universe.md), decoherence can yield effectively autonomous records for alternatives with nonzero amplitude, and [Measure](09-measure-vantage-branchcone.md) assigns Born weight to specified event sectors rather than to a countable inventory of worlds. As [Everett's Demon](14-everetts-demon.md) qualified, some microscopic differences can feed sensitive dynamics and become macroscopically distinct; the frequency and decision-level importance of such amplification are empirical questions, not guaranteed at every scale or moment.
