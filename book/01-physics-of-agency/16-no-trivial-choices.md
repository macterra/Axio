...
The second is quantum branching. In the [Quantum Branching Universe (QBU)](08-the-quantum-branching-universe.md), unitary evolution and decoherence support emergent record histories at a declared grain; specified outcome sectors carry objective [Measure](09-measure-vantage-branchcone.md) without branches becoming countable worlds. And as [Everett's Demon](14-everetts-demon.md) showed, some microscopic differences do not stay microscopic: neural noise, molecular collisions, and thermal fluctuations can amplify quantum differences into divergent macroscopic outcomes — different chess moves, different sentences, different decisions — across ordinary life.
