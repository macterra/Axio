...
The preceding chapters have been prosecution. [The Coercion Continuum](03-the-coercion-continuum.md) established what taxation is: a point on a spectrum of coercive extraction that runs from self-sovereignty to chattel slavery, with no bright line anywhere along it. [Extortion-Funded Organizations](04-extortion-funded-organizations.md) established what the state is: an organization funded by payments extracted under threat, distinguished from a protection racket by institutionalization and acceptance rather than by method. Those chapters tell you what you are looking at. They do not tell you what would have to be true for any of it to be justified. That is this chapter's job, and it is the hinge of the whole volume: the indictment states the facts; here are the court's standards.

Coercion has a simple structure — [the credible threat of actual harm to gain compliance](../05-value-and-ethics/09-what-counts-as-coercion.md) — and the moral question is whether that threat preserves agency or commandeers it. Agency is the relevant axis because coercion operates by overriding agency. Other values matter: survival, stability, prosperity, order, continuity, trust. But coercion is the specific political instrument that converts one agent's purposes into another agent's constraint. That makes agency the first thing to examine, even when other values are also at stake — the same reason [the Agency Protection Principle](02-upgrading-liberty.md) puts agency, not any rival value, at the center of the political question.
...
Defensive force against an attacker is justified because the attacker has already initiated an agency violation; the defender's coercion tracks that prior violation and aims to stop it. Restitution against theft or fraud is similarly clean: the coercion tracks a prior violation and aims to repair it. At the other end sit the equally easy cases of naked domination — force applied to no prior violation at all, for the enforcer's benefit, against agents who threatened no one. Both ends of the spectrum can be read off directly, and any honest theory of coercion has to get them right without effort.
...
Redistribution becomes *justice*, as though the transfer were restitution for an adjudicated theft rather than a standing claim on whatever anyone produces. Censorship becomes *safety*, as though the suppressed speech were a swung fist — a move examined in detail [where speech ends](09-where-speech-ends.md). War becomes *defense*, whatever ocean the enemy is behind. Moral regulation becomes *protection*, with the adults being protected never asked whether they want it. Property enforcement becomes *peace*, however the titles were acquired. Border exclusion becomes *security*, an equation [taken apart later in this volume](16-borders-and-movement.md). Every faction has its own preferred coercion, and every faction redescribes it as the repair of a prior violation. The vocabulary of the green zone is the most valuable rhetorical real estate in politics, which is exactly why it must be defended.
...
1. **Identify the agents.** Not "society," not "the nation," not "the public" — the actual persons coercing and the actual persons coerced.
2. **Specify the alleged agency violation.** What, precisely, did the coerced party do or threaten? A justification that cannot name the violation is not a justification.
3. **State the background conditions.** The interpretations of ownership, consent, capacity, authority, and harm on which the claim depends — and then ask who initiated the violation *under those conditions*, not under a flattering simplification of them.
4. **Demand evidence proportional to the severity of the coercion.** A fine can rest on lighter evidence than a prison term; a permanent regime over millions requires more than a model and a press conference.
5. **Bound the response.** Necessity, proportionality, reversibility, and termination conditions — stated in advance, not improvised by the enforcer as it goes.
6. **Check what the enforcement creates.** Does the mechanism preserve future agency, or does it create a standing authority class with a permanent interest in expanding its domain?
...
Coercion is sometimes necessary, because agency can be attacked. It is always dangerous, because agency can also be attacked in the name of protecting it. That is the grey zone. It cannot be abolished — only kept honest. And any philosophy that pretends to abolish it, from whichever end of the spectrum, is selling authority with cleaner branding.
