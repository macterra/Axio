...
Lucy Connolly, a British childminder, was sentenced to thirty-one months after posting: “Mass deportation now, set fire to all the f\*\*\*\*\* hotels full of the bastards for all I care.” The facts recorded by the [Court of Appeal](https://www.judiciary.uk/judgments/lucy-connolly-v-the-king/) belong in any honest account: she pleaded guilty to distributing material intending to stir up racial hatred, had thousands of followers, and posted during the public disorder following false claims about the Southport killer. Grant all of it, including the intent the court found. It still is not *coercion*, and the reason has nothing to do with her state of mind. Coercion is the credible threat of actual harm to a victim to gain that victim's compliance — and Connolly threatened no one into anything. Her tweet named no target and demanded nothing of anyone; it was an exhortation broadcast to a diffuse audience, not a threat leveraged against a particular person's choices. A message that compels no specific victim fails the coercion test whatever the speaker meant by it, because intent is not one of the test's elements. So the coercion-shaped reasoning some bring to the case misfires on contact: a state that jails her under a statute against speech "likely to stir up racial hatred" is punishing the anticipated *effect* of expression, not the presence of a threat. Whether her words instead cross the different line of incitement is a real question — and it is the one the rest of this chapter is built to answer.
