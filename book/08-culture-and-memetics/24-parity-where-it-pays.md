...
This comparison is an instrument, and it returns in [the taboo test](27-the-taboo-test.md): the asymmetry between what a norm claims to cover and where it actually bites identifies an omitted term to investigate. It does not, by itself, tell you the motive.
